...
function Parentlogincreadential() {
          ...
          <div className={styles.topmenubar}>
            <div className={styles.searchoptiondiv}>
              <form onSubmit={filterdata} className={styles.searchoptiondiv}>
                ...
                <button>Get Login Credentails</button>
              </form>
              ...
              <table className={styles.tabletable}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Parent_Name</th>
                    <th className={styles.tableth}>Login Phone No</th>
                    <th className={styles.tableth}>Default Password</th>
                  ...
                  {isdata?.map((item, index) => {
                    return (
                      <tr key={index} className={styles.tabletr}>
                        ...
                        <td className={styles.tabletd}>{user?.data?.CredentailsData?.Employeepassword}</td>
...
export default Parentlogincreadential;
