...
import AddAdmission from "../../../component/Institute/student/AddOtherFee";
import UpdateAdmission from "../../../component/Institute/student/UpdateOtherFee";
...
function OtherFee() {
  ...
  const handledelete = () => {
    serverInstance("student/otherfee", "delete", {
      othersfeeobj: deleteid,
    }).then((res) => {
      if (res?.status === true) {
  ...
  const filterdata = (e) => {
    e.preventDefault();
    dispatch(GeOtherFees(scoursename, datedues, sessionname, sectionname));
  };
            ...
            <div className={styles.searchoptiondiv}>
              <form onSubmit={filterdata} className={styles.searchoptiondiv}>
                ...
                <input
                  ...
                  value={datedues}
                  name="datedues"
                  onChange={(e) => setdatedues(e.target.value)}
                />
              ...
              <table className={styles.tabletable}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Dues</th>
                    ...
                    isdata?.map((item, index) => {
                      return (
                        <tr key={index} className={styles.tabletr}>
                          ...
                          <td className={styles.tabletd}>
                            {moment(item?.DuesDate).format("DD/MM/YYYY")}
                          </td>
