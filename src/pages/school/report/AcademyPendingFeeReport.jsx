...
function AcademyPendingFeeReport() {
  ...
  const TotalRegistrationFee = (data) => {
    let total = 0;
    data?.map((item) => {
      if (item?.Registrationfeestatus === false) {
  ...
  const ExportToExcel = (isData) => {
    const fileName = "StudentAllPendingeport";
    ...
    isData.map((item, index) => {
      data.push({
        ...
        Annual_Fee: item?.AnnualFeeStatus ? "0" : item?.AnnualFee,
        Academy_Pending_Fee: item?.pendingfee,
        // Hostel_Pending_Fee: item?.hostal ? item?.HostelPendingFee : "Not Have",
        // Transport_Pending_Fee: item?.Transport
        //   ? item?.TransportPendingFee
        //   : "Not Have",
      });
    });
              ...
              <table className={styles.tabletable} ref={componentRef}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Academy_Pending_Fee</th>
                    {/* <th className={styles.tableth}>Hostel_Fee</th> */}
                    {/* <th className={styles.tableth}>Hostel_Pending_Fee</th> */}
                    {/* <th className={styles.tableth}>Transport_Fee</th> */}
                    {/* <th className={styles.tableth}>Transport_Pending_Fee</th> */}
                    {newmonthnames &&
                  ...
                  {isdata?.map((item, index) => {
                    return (
                      <tr key={index} className={styles.tabletr}>
                        ...
                        <td className={styles.tabletd}>{item?.pendingfee}</td>

                        {/* <td className={styles.tabletd}>
                          {item?.TotalHostelFee}
                        </td> */}
                        {/* <td className={styles.tabletd}>
                          {item?.hostal ? item?.HostelPendingFee : "Not Have"}
                        </td> */}
                  ...
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>
                      {isdata?.length > 0 &&
                        isdata?.reduce(
                          (n, { pendingfee }) =>
                            parseFloat(n) + parseFloat(pendingfee),
                          0
                        )}
                    </th>
                    {/* <th className={styles.tableth}>Hostel_Fee</th> */}
                    {/* <th className={styles.tableth}>
                      {isdata?.length > 0 &&
                        isdata?.reduce(
                          (n, { HostelPendingFee }) =>
                            parseFloat(n) + parseFloat(HostelPendingFee),
                          0
                        )}
                    </th> */}
                    {/* <th className={styles.tableth}>Transport_Fee</th> */}
                    {/* <th className={styles.tableth}>
                      {isdata?.length > 0 &&
                        isdata?.reduce(
                          (n, { TransportPendingFee }) =>
                            parseFloat(n) + parseFloat(TransportPendingFee),
                          0
                        )}
                    </th> */}
                    {newmonthnames &&
...
export default AcademyPendingFeeReport;
