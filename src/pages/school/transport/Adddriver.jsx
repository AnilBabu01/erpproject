...
import AddStudentCategory from "@/component/Institute/transport/AddDriver";
import UpdateCategory from "@/component/Institute/transport/UpdateDriver";
              ...
              <table className={styles.tabletable}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Driver Name</th>
                    <th className={styles.tableth}>Driver Phone</th>
                    <th className={styles.tableth}>Pan Card No</th>
                    <th className={styles.tableth}>Aadhar Card NO</th>
                  ...
                  {isdata?.map((item, index) => {
                    return (
                      <tr key={index} className={styles.tabletr}>
                        ...
                        <td className={styles.tableth}>Driver Name</td>
                        <td className={styles.tableth}>Driver Phone</td>
                        <td className={styles.tableth}>Pan Card No</td>
                        <td className={styles.tableth}>Aadhar Card NO</td>
