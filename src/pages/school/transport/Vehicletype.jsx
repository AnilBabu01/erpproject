...
import AddStudentCategory from "@/component/Institute/transport/AddVehiceType";
import UpdateCategory from "@/component/Institute/transport/UpdateVehicleType";
...
function Vehicletype() {
  ...
  const handledelete = () => {
    serverInstance("transport/vehicletype", "delete", {
      id: deleteid,
    }).then((res) => {
      if (res?.status === true) {
              ...
              <table className={styles.tabletable}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Vehicle Type</th>
