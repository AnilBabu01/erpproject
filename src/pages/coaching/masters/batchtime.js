...
import { getbatch, deletebatch } from "../../../redux/actions/commanAction";
...
function Batchtime() {
  ...
  const handledelete = () => {
    dispatch(deletebatch(deleteid, setOpenalert));
  };
    ...
    <>
      ...
      {openupdate && (
        <div>
          ...
          >
            <UpdateBatch setOpen={setOpenupdate} updatedata={updatedata} />
          </Dialog>
        </div>
      )}
              ...
              <table className={styles.tabletable}>
                <tbody>
                  <tr className={styles.tabletr}>
                    ...
                    <th className={styles.tableth}>Batch Starting Time</th>
                    <th className={styles.tableth}>Batch Ending Time</th>
