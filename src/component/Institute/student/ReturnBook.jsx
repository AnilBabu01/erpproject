            ...
            <table className={styles.tabletable}>
              <tbody>
                <tr className={styles.tabletr}>
                  ...
                  <th className={styles.tableth}>Return</th>
                  <th className={styles.tableth}>Fine</th>
                </tr>
                ...
                <tr className={styles.tabletr}>
                  ...
                  <td className={styles.tableth}>10</td>
                </tr>
                <tr className={styles.tabletr}>
                  <td className={styles.tableth}>&nbps;</td>
                  <td className={styles.tableth}>&nbps;</td>

                  <td className={styles.tableth}>Total Fine</td>
                  <td className={styles.tableth}>10</td>
                </tr>
              </tbody>
            </table>
