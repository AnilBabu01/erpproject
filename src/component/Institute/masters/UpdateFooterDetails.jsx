...
function UpdateFooterDetails({ setOpen, updatedata }) {
  ...
  useEffect(() => {
    if (updatedata) {
      ...
      setChairman(updatedata?.ChairmanContactNo);
      setPrincipalNo(updatedata?.PrincipalContactNo);
      setfacebookurl(updatedata?.facebookurl);
      setinstagramurl(updatedata?.instagramurl);
      setlinkedinurl(updatedata?.linkldlurl);
      setMapURL(updatedata?.Mapurl);
      setFacilities(updatedata?.facilitycontent);
      settwiterurl(updatedata?.twiterurl);
    }
  }, []);
...
export default UpdateFooterDetails;
