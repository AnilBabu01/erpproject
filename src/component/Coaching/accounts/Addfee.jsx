        ...
        <form>
          <div className={styles.mainfeedetails}>
            ...
            <div>
              <div className={styles.inputdivpay}>
                <p>Total Fee</p>
                <p className={styles.hightlighttext}>{data?.studentTotalFee}</p>
              </div>
              <div className={styles.inputdivpay}>
                <p>Fee per month</p>
              ...
              <div className={styles.inputdivpay}>
                ...
                <p className={styles.hightlighttext}>{data?.regisgrationfee}</p>
              </div>
            </div>
            <div>
              <div className={styles.inputdivpay}>
            ...
            <div>
              <div className={styles.inputdivpay}>
                <p>Course Duraion</p>
                <p className={styles.hightlighttext}>{data?.courseduration}</p>
              </div>
              <div className={styles.inputdivpay}>
                <p>Roll No</p>
